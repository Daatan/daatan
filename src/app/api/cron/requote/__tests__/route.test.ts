...
const emptySummary = {
  ...
  skippedNoAnchor: 0, skippedTeffBeforeAnchor: 0, skippedUnlatchedPin: 0, selfHealed: 0,
  divergenceAlerts: 0, deadlineAlerts: 0, provisionalAlerts: 0, pendingDeadlineAlerts: 0, settledDriftAlerts: 0, unlatchedPinAlerts: 0, errors: 0, deltas: [],
}
