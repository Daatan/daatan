...
ENV_ARGS="$ENV_ARGS -e SERPAPI_API_KEY=${SERPAPI_API_KEY}"
ENV_ARGS="$ENV_ARGS -e SCRAPINGBEE_API_KEY=${SCRAPINGBEE_API_KEY}"
ENV_ARGS="$ENV_ARGS -e BRIGHTDATA_API_KEY=${BRIGHTDATA_API_KEY}"
ENV_ARGS="$ENV_ARGS -e NIMBLEWAY_API_KEY=${NIMBLEWAY_API_KEY}"
ENV_ARGS="$ENV_ARGS -e DATAFORSEO_LOGIN=${DATAFORSEO_LOGIN}"
ENV_ARGS="$ENV_ARGS -e DATAFORSEO_PASSWORD=${DATAFORSEO_PASSWORD}"
...
ENV_ARGS="$ENV_ARGS -e TEMPORAL_CLOCK_DISABLED=${TEMPORAL_CLOCK_DISABLED}"
...
ENV_ARGS="$ENV_ARGS -e TELEGRAM_CLEAN_CHAT_ID=${TELEGRAM_CLEAN_CHAT_ID}"
ENV_ARGS="$ENV_ARGS -e TELEGRAM_WEBHOOK_SECRET=${TELEGRAM_WEBHOOK_SECRET}"
ENV_ARGS="$ENV_ARGS -e TELEGRAM_ROLLBACK_CHAT_IDS=${TELEGRAM_ROLLBACK_CHAT_IDS}"
ENV_ARGS="$ENV_ARGS -e GH_ROLLBACK_TOKEN=${GH_ROLLBACK_TOKEN}"
ENV_ARGS="$ENV_ARGS -e STAGING_URL=${STAGING_URL:-https://staging.daatan.com}"
ENV_ARGS="$ENV_ARGS -e NEWS_INDEXER_SECRET=${NEWS_INDEXER_SECRET}"
ENV_ARGS="$ENV_ARGS -e NEWS_INDEXER_URL=${NEWS_INDEXER_URL}"
ENV_ARGS="$ENV_ARGS -e NEWS_INDEXER_API_KEY=${NEWS_INDEXER_API_KEY}"
ENV_ARGS="$ENV_ARGS -e NEXT_PUBLIC_APP_VERSION=${NEXT_PUBLIC_APP_VERSION}"
ENV_ARGS="$ENV_ARGS -e ORACLE_URL=${ORACLE_URL}"
ENV_ARGS="$ENV_ARGS -e ORACLE_API_KEY=${ORACLE_API_KEY}"
ENV_ARGS="$ENV_ARGS -e INDEXNOW_KEY=${INDEXNOW_KEY}"
ENV_ARGS="$ENV_ARGS -e GOOGLE_INDEXING_CLIENT_EMAIL=${GOOGLE_INDEXING_CLIENT_EMAIL}"
ENV_ARGS="$ENV_ARGS -e GOOGLE_INDEXING_PRIVATE_KEY=${GOOGLE_INDEXING_PRIVATE_KEY}"
